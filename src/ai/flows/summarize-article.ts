...
/**
 * @fileOverview Provides a summary of a news article.
 *
...
const SummarizeArticleOutputSchema = z.object({
  summary: z
    .string()
    .describe('A concise summary of the news article, highlighting the main points.'),
});
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an expert news summarizer. Please provide a concise summary of the following news article, highlighting the main points:\n\n{{{articleText}}}`,
});
